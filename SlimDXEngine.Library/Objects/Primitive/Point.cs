...
{
    public class Point : PositionedObject
    {
        #region Fields
        #endregion
        #region Properties
        ...
        internal override void Draw(SlimDX.Direct3D11.DeviceContext context)
        {
            ...
            DataStream vertices = new DataStream((Vector3.SizeInBytes + 4) * 1, true, true);
            vertices.Write(new ColoredVertex(new Vector3(0.0f, 0.0f, 0.0f), new Color4(1.0f, 0.0f, 0.0f, 0.0f).ToArgb()));
            vertices.Position = 0;
